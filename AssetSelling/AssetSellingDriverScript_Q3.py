...
if __name__ == "__main__":
    ...
    printIterations = [0, *list(reversed(range(nIterations-1,0,-printStep)))]
    ...
    start = time.time()
    #####
    if policy_selected not in ['full_grid', 'track']:
    #####
        ...
        contribution_iterations = [
            ...
            for _ in list(range(nIterations))
        ]
        ...
        fig.suptitle(
            f"Asset selling using policy {policy_selected} with parameters {policy_info[policy_selected]} and T {T}"
        )
        ...
        for theta in theta_range:
            ...
            for k in range(nIterations):
                ...
                print(
                    f"Iteration {k} for theta {theta}. The contribution was {contrib} and the stopping time was {t_stop}"
                )
                print("\n")
            ...
            print("**************************************************************************************")
            print(
                f"Finishing iterations for theta {theta}. Average contribution {avg_contrib} and average stopping time {avg_t_stop}"
            )
